-- ═══════════════════════════════════════════════════════
--  PetSit — schema.sql corregido
--  Cambios respecto al original:
--    · mascotas: agrega msc_sexo y msc_fecha_nacimiento
--      (campos presentes en Mascota.java pero ausentes en la tabla)
-- ═══════════════════════════════════════════════════════
...
CREATE TABLE mascotas (
                          ...
                          msc_sexo            VARCHAR(20),          -- Macho / Hembra  ← NUEVO
                          msc_fecha_nacimiento DATE DEFAULT NULL,   -- fecha de nac.   ← NUEVO
                          msc_dueno_id        INT,
...
CREATE TABLE alertas (
                         ...
                         alt_mascota_id  INT,                              -- puede ser NULL
...
-- Índice para búsquedas geoespaciales de alertas
